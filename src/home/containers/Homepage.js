...
export default function Homepage(props) {
    ...
    return (
        <div className="jumbotron">
            ...
            <h1 style={{ textAlign: 'center', margin: "0px 50px" }}> Start trading your sports cards today!</h1>
            <ul>
            ...
            <div>
                <p> When you're ready to start adding your cards, making trade requests, viewing your trades or accepting offers! </p>
                <div>
